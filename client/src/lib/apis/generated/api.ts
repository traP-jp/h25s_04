 ...
 * @export
 */
export const EateriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        eateriesEateryIdGet: async (eateryId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eateryId' is not null or undefined
            assertParamExists('eateriesEateryIdGet', 'eateryId', eateryId)
            const localVarPath = `/eateries/{eateryId}`
                .replace(`{${"eateryId"}}`, encodeURIComponent(String(eateryId)));
        ...
        eateriesEateryIdPut: async (eateryId: string, eateryUpdate: EateryUpdate, xForwardedUser?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(eateryUpdate, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        eateriesGet: async (query?: string, page?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        eateriesPost: async (eateryCreate: EateryCreate, xForwardedUser?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(eateryCreate, localVarRequestOptions, configuration)
...
export const EateriesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async eateriesEateryIdGet(eateryId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Eatery>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.eateriesEateryIdGet(eateryId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EateriesApi.eateriesEateryIdGet']?.[localVarOperationServerIndex]?.url;
 ...
 * @export
 */
export const EateriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        eateriesEateryIdGet(eateryId: string, options?: RawAxiosRequestConfig): AxiosPromise<Eatery> {
            return localVarFp.eateriesEateryIdGet(eateryId, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates an existing eatery\'s information
         * @summary Update eatery
...
export class EateriesApi extends BaseAPI {
     ...
     */
    public eateriesEateryIdGet(eateryId: string, options?: RawAxiosRequestConfig) {
        return EateriesApiFp(this.configuration).eateriesEateryIdGet(eateryId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EateriesApi
     */
    public eateriesGet(query?: string, page?: number, limit?: number, options?: RawAxiosRequestConfig) {
        return EateriesApiFp(this.configuration).eateriesGet(query, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ImagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        imagesImageIdGet: async (imageId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ImagesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async imagesImageIdGet(imageId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imagesImageIdGet(imageId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ImagesApi.imagesImageIdGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Uploads an image file and returns its ID
         ...
         * @throws {RequiredError}
         */
        async imagesPost(image: File, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImageUploadResponse>> {
...
export const ImagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        imagesImageIdGet(imageId: string, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.imagesImageIdGet(imageId, options).then((request) => request(axios, basePath));
        },
        /**
         * Uploads an image file and returns its ID
         * @summary Upload image
         ...
         * @throws {RequiredError}
         */
        imagesPost(image: File, options?: RawAxiosRequestConfig): AxiosPromise<ImageUploadResponse> {
...
export class ImagesApi extends BaseAPI {
    ...
    public imagesImageIdGet(imageId: string, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).imagesImageIdGet(imageId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ReviewsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        eateriesEateryIdReviewsGet: async (eateryId: string, sortBy?: EateriesEateryIdReviewsGetSortByEnum, page?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'eateryId' is not null or undefined
            assertParamExists('eateriesEateryIdReviewsGet', 'eateryId', eateryId)
            const localVarPath = `/eateries/{eateryId}/reviews`
                .replace(`{${"eateryId"}}`, encodeURIComponent(String(eateryId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        eateriesEateryIdReviewsPost: async (eateryId: string, reviewCreate: ReviewCreate, xForwardedUser?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('eateriesEateryIdReviewsPost', 'reviewCreate', reviewCreate)
            const localVarPath = `/eateries/{eateryId}/reviews`
                .replace(`{${"eateryId"}}`, encodeURIComponent(String(eateryId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        reviewsGet: async (sortBy?: ReviewsGetSortByEnum, page?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        reviewsReviewIdGet: async (reviewId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'reviewId' is not null or undefined
...
export const ReviewsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async reviewsReviewIdGet(reviewId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReviewDetail>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.reviewsReviewIdGet(reviewId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ReviewsApi.reviewsReviewIdGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Updates an existing review
...
export const ReviewsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        reviewsReviewIdGet(reviewId: string, options?: RawAxiosRequestConfig): AxiosPromise<ReviewDetail> {
            return localVarFp.reviewsReviewIdGet(reviewId, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates an existing review
         * @summary Update review
...
export class ReviewsApi extends BaseAPI {
     ...
     * @memberof ReviewsApi
     */
    public eateriesEateryIdReviewsGet(eateryId: string, sortBy?: EateriesEateryIdReviewsGetSortByEnum, page?: number, limit?: number, options?: RawAxiosRequestConfig) {
        return ReviewsApiFp(this.configuration).eateriesEateryIdReviewsGet(eateryId, sortBy, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ReviewsApi
     */
    public reviewsGet(sortBy?: ReviewsGetSortByEnum, page?: number, limit?: number, options?: RawAxiosRequestConfig) {
        return ReviewsApiFp(this.configuration).reviewsGet(sortBy, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public reviewsReviewIdGet(reviewId: string, options?: RawAxiosRequestConfig) {
        return ReviewsApiFp(this.configuration).reviewsReviewIdGet(reviewId, options).then((request) => request(this.axios, this.basePath));
    }
...
export type EateriesEateryIdReviewsGetSortByEnum = typeof EateriesEateryIdReviewsGetSortByEnum[keyof typeof EateriesEateryIdReviewsGetSortByEnum];
/**
 * @export
 */
...
export type ReviewsGetSortByEnum = typeof ReviewsGetSortByEnum[keyof typeof ReviewsGetSortByEnum];
